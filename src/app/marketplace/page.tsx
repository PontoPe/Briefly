  ...
  return (
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-6 lg:px-8 py-20 lg:py-28 text-center">
      ...
      {/* Category Filters */}
      <div className="mx-auto max-w-[1440px] px-6 lg:px-8 -mt-5 relative z-10">
      ...
      <section className="mx-auto max-w-[1440px] px-6 lg:px-8 pb-16">
        <div className="bg-surface-container rounded-[2rem] p-8 lg:p-12 flex flex-col lg:flex-row items-center gap-10 relative overflow-hidden">
          ...
          <div className="relative w-80 h-60 flex-shrink-0">
            <div className="absolute top-0 left-0 w-36 h-44 bg-surface-container-lowest rounded-2xl shadow-[0_20px_40px_rgba(29,27,32,0.08)] rotate-[-6deg]" />
            <div className="absolute top-4 left-12 w-36 h-44 bg-surface-container-low rounded-2xl shadow-[0_20px_40px_rgba(29,27,32,0.08)] rotate-[3deg]" />
            ...
            <div className="absolute top-8 left-36 w-36 h-44 bg-primary-fixed rounded-2xl shadow-[0_20px_40px_rgba(29,27,32,0.08)] rotate-[-3deg]" />
          </div>
        </div>
      </section>

      {/* Explore Collection */}
      <section className="mx-auto max-w-[1440px] px-6 lg:px-8 pb-20">
        <div className="flex items-end justify-between mb-8">
          <h2 className="font-display text-headline-lg font-extrabold text-on-surface">
          ...
          {collectionAssets.map((asset) => (
            ...
            >
              <div className="aspect-square bg-surface-container relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-tertiary/5 group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 flex items-center justify-center">
